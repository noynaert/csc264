...
\end{samepage}
\begin{samepage}
    \question Many assembly language instructions use two operands.  What order do GAS assemblers use?  (Hint: Is it source, destination or destination, source?)
    \vspace{5mm}
\end{samepage}
\par
 \begin{samepage}
...
\par
 \begin{samepage}
     \question How many bits are in the ax register? \rule{1cm}{0.15mm}
     \newline How many bits are in the eax register? \rule{1cm}{0.15mm}
     \newline How many bits are in the rax register? \rule{1cm}{
     \end{parts}
     \vspace{5mm}
 \end{samepage}
  ...
  \begin{samepage}
      ...
      \newline Was the eax register available on the 80386? \rule{1cm}{0.15mm}
      \newline Was the rax register available on the 80386? \rule{1
  \end{samepage}
  \par
